...
where $B^t$ and $W^t$ refer to the respective matrix at step t. Hence, as long as $0 < \lambda < 1$, the $W$ and $B$ matrices will converge, and with that the respective gradients align.

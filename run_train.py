...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs", type=int, default=5,
                        help="Number of training epochs. Type: int, Default: 5")
    ...
    parser.add_argument("--in_dim", type=int, default=1,
                        help="Input vector dimension. Type: int, Default: 1")
    parser.add_argument("--seq_len", type=int, default=1,
                        help="Length of input sequence. Type: int, Default: 1")
    parser.add_argument("--output_features", type=int, default=10,
    ...
    parser.add_argument("--test_set_size", type=int, default=10,
                        help="Size of the test set. Type: int, Default: 10")
    parser.add_argument("--teacher_act", type=str, default="sigmoid",
                        help="Activation function of teacher network. Type: str, Default: 'sigmoid'")
    parser.add_argument("--lr", type=float, default=0.02,
                        help="Learning rate. Type: float, Default: 0.02")
    parser.add_argument("--momentum", type=float, default=0,
                        help="Momentum value. Type: float, Default: 0")
    parser.add_argument("--weight_decay", type=float, default=0,
                        help="Weight decay for learning. Type: float, Default: 0.")
    parser.add_argument("--plot", type=str2bool, default=True,
                        help="Enable/disable plotting. Type: boolean, Default: True")
    ...
    parser.add_argument("--wandb_project", type=str, default="test_project",
                        help="Weights & Biases project name. Type: str, Default: 'test_project'")
    parser.add_argument("--use_wandb", type=str2bool, default=True,
                        help="Enable/disable Weights & Biases for logging. Type: boolean, Default: True")
    parser.add_argument("--n", type=int, default=5,
                        help="Batches for alignment averaging. Type: int, Default: 5")
